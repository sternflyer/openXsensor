...
*************************************************************************************
See openXsensor-extended-HoTT https://github.com/sternflyer/openXsensor-extended-HoTT/
and OpenXsensor https://github.com/openXsensor/
...
* 1.1 - Selecting a specific HoTT sensor type and enabling Text-Mode: *********************************************
* A specific HoTT sensor type (GAM or EAM) can be selected. Standard is GAM
* HoTT Text mode can be enabled to edit Current and Voltage setting live in the HoTT Menu. 
* An ID for Text-Mode has to be defined!
************************************************************************************************************************
#define HOTT_SENSOR	GAM	// select between GAM and EAM
#define HOTT_TEXT		//Enables Text Mode for HOTT. Uncomment if you don't want it
#define HOTT_SENSOR_TEXT HOTTV4_GAM_SENSOR_TEXT_ID  //select between HOTTV4_GAM_SENSOR_TEXT_ID and HOTTV4_EAM_SENSOR_TEXT_ID. MEST BE DEFINED!!!
