...
// --------- 1 - Telemetry protocol ---------  Is defined only in oXs_config_basic.h file
...
#define MVOLT_AT_ZERO_AMP              0    // in millivolt
#define MVOLT_PER_AMP                  66.7      // in milliVolt per Amp
...
// --------- 9 - Data to transmit ---------                                         Is defined only in oXs_config_basic.h file
...
#define USE_HMC5883 // uncomment this line if you want to use the magnetometer to calculate Yaw
...
//for HOTT Sensor selection
//#define VARIO HOTT_TELEMETRY_VARIO_SENSOR_ID
#define GPS HOTT_TELEMETRY_GPS_SENSOR_ID
#define ESC HOTTV4_ESC_SENSOR_ID
#define GAM HOTT_TELEMETRY_GAM_SENSOR_ID
#define EAM HOTT_TELEMETRY_EAM_SENSOR_ID
...
/*	
	...
	#if ( HOTT_SENSOR == EAM )
		#define HOTT_SENSOR_TEXT HOTTV4_EAM_SENSOR_TEXT_ID
	#endif

	#if (HOTT_SENSOR == GPS)
		#define HOTT_SENSOR_TEXT HOTTV4_GPS_SENSOR_TEXT_ID
	#endif

	#if (HOTT_SENSOR == VARIO)
		#define HOTT_SENSOR_TEXT HOTTV4_VARIO_SENSOR_TEXT_ID
	#endif

	#if (HOTT_SENSOR == ESC)
		#define HOTT_SENSOR_TEXT HOTTV4_ESC_SENSOR_TEXT_ID
	#endif
#endif*/
